...
public class ChatMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private CharSequence chat_id;
  private CharSequence audio_message_id;
  private CharSequence image_id;
   ...
   */
  public ChatMessage(CharSequence id, CharSequence chat_id, CharSequence audio_message_id, CharSequence image_id, CharSequence timestamp) {
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: chat_id = (CharSequence)value$; break;
    case 2: audio_message_id = (CharSequence)value$; break;
    case 3: image_id = (CharSequence)value$; break;
   ...
   * @param value the value to set.
   */
  public void setChatId(CharSequence value) {
    this.chat_id = value;
  }
   ...
   */
  public CharSequence getAudioMessageId() {
   ...
   * @param value the value to set.
   */
  public void setAudioMessageId(CharSequence value) {
   ...
   * @param value the value to set.
   */
  public void setImageId(CharSequence value) {
    this.image_id = value;
  }
   ...
   * @return A new ChatMessage RecordBuilder
   */
  public static Builder newBuilder(ChatMessage other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChatMessage>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setChatId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAudioMessageId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearAudioMessageId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setImageId(CharSequence value) {
    ...
    public ChatMessage build() {
      try {
        ...
        record.chat_id = fieldSetFlags()[1] ? this.chat_id : (CharSequence) defaultValue(fields()[1]);
        record.audio_message_id = fieldSetFlags()[2] ? this.audio_message_id : (CharSequence) defaultValue(fields()[2]);
        record.image_id = fieldSetFlags()[3] ? this.image_id : (CharSequence) defaultValue(fields()[3]);
